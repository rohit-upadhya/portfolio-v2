export default function LlmsThink({ onClose }){
    return(
        <div className="max-w-5xl mx-auto space-y-4 py-8" >
            <div>
            <a href="#" className="text-blue-600 hover:underline" onClick={(e) => { e.preventDefault(); onClose(); }}>← Back to Blogs</a>
            </div>
            ...
            <p className="text-gray-700 mb-2">
                They have used something called a sparse autoencoder, that tries to measure how the various neurons fire up at a given layer, given a particular input. Anthropic's paper is linked <a href="https://transformer-circuits.pub/2024/scaling-monosemanticity/index.html" className="text-blue-600 hover:underline" target="_blank">here</a>. Again, I am not sure if this is even the latest research (judging by the fact that it was published in May 2024, it does not appear to be bleeding edge anymore lol). I will be sure to add more content here, as and when I update my knowledge.
            </p>
            <div>
            <a href="#" className="text-blue-600 hover:underline" onClick={(e) => { e.preventDefault(); onClose(); }}>← Back to Blogs</a>
            </div>
